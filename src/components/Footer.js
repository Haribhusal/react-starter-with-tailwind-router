...
const Footer = () => {
  return (
    <>
      <div className="container-sm md:container sm:px-3 bg-orange-700 text-white py-16">
        <div className="flex md:flex-row sm:flex-col justify-between items-center sm:items-start">
          ...
          <a
            href="#"
            className="bg-orange-600 shadow-lg hover:shadow-sm transition-all sm:mt-5 md:mt-0 px-10 h-16 py-5 rounded flex items-center"
          >
        ...
        <div className="flex justify-between sm:flex-col md:flex-row">
          ...
          <div className="item md:px-5 sm:px-0 ">
            ...
            <form action="" className="flex mt-5">
              ...
              />
              <button className="btn px-3 py-2 bg-orange-900 w-48">

            ...
            <div className="info mt-3">
                ...
                <>
                    <p className="text text-base text-slate-700 mt-3">
                     ...
                     <button className='bg-orange-100 px-5 py-3 rounded font-bold text-orange-700'>  Read More <i className="las la-arrow-right ml-2"></i> </button>
                 </div>
                </>
                }
                {type === 'product' &&
                    ...
                    <div className="buttons mt-5">
                        <button className='bg-orange-100 px-5 py-3 rounded font-bold text-orange-700'> <i className="las la-shopping-cart mr-2"></i> Add to Cart </button>
                    </div>
                }
                {type === 'post' &&
                <>
